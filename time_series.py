...
freq_map  = {"B":250,"D":365,"d":365, "W":52,"M":12,"A":1,"2":52,"Z":9999}
freq_rev_map = {250:"B", 365:"D", 1:"A",12:"M", 52:"W",0:"Z"}
...
def align_series_frequency(series_arr):
    """
    ...
    freqs = [freq_map[get_frequency(ser)[0]] for ser in good_series]
...
def align_series(series_arr, jointype='inner'):
    """
    ...
    """
    series_common = align_series_frequency(series_arr)
